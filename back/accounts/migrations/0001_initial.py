    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preferred_locations', models.TextField(blank=True, verbose_name='المواقع المفضلة')),
                ('property_preferences', models.TextField(blank=True, verbose_name='تفضيلات العقارات')),
            ],
            options={
