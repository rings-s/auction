# Generated by Django 5.1.4 on 2025-03-20 11:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location_latitude', models.FloatField(blank=True, null=True, verbose_name='خط عرض الموقع')),
                ('location_longitude', models.FloatField(blank=True, null=True, verbose_name='خط طول الموقع')),
                ('location_details', models.JSONField(blank=True, default=dict, null=True, verbose_name='تفاصيل الموقع')),
                ...
                ('images', models.JSONField(blank=True, default=list, null=True, verbose_name='صور المزاد')),
                ('videos', models.JSONField(blank=True, default=list, null=True, verbose_name='فيديوهات المزاد')),
                ('documents', models.JSONField(blank=True, default=list, null=True, verbose_name='مستندات المزاد')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_info', models.JSONField(blank=True, default=dict, null=True, verbose_name='معلومات الجهاز')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('files', models.JSONField(blank=True, default=list, null=True, verbose_name='ملفات العقد')),
                ('terms_conditions', models.TextField(blank=True, null=True, verbose_name='الشروط والأحكام')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thread_type', models.CharField(choices=[('inquiry', 'استفسار'), ('negotiation', 'تفاوض'), ('support', 'دعم'), ('notification', 'إشعار'), ('private', 'خاص')], default='inquiry', max_length=20, verbose_name='نوع المحادثة')),
                ...
                ('resolved_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='resolved_threads', to=settings.AUTH_USER_MODEL, verbose_name='تم الحل بواسطة')),
            ],
            options={
                'verbose_name': 'محادثة',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message_type', models.CharField(choices=[('inquiry', 'استفسار'), ('offer', 'عرض'), ('negotiation', 'تفاوض'), ('notification', 'إشعار'), ('update', 'تحديث'), ('support', 'دعم')], default='inquiry', max_length=20, verbose_name='نوع الرسالة')),
                ...
                ('attachments', models.JSONField(blank=True, default=list, null=True, verbose_name='المرفقات')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('files', models.JSONField(blank=True, default=list, null=True, verbose_name='ملفات الدفعة')),
                ('notes', models.TextField(blank=True, null=True, verbose_name='ملاحظات')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_history', models.JSONField(blank=True, default=list, null=True, verbose_name='سجل حالات العقار')),
                ...
                ('location', django.contrib.gis.db.models.fields.PointField(blank=True, geography=True, null=True, srid=4326, verbose_name='الموقع على الخريطة')),
                ...
                ('street_details', models.JSONField(blank=True, default=dict, null=True, verbose_name='تفاصيل الشوارع')),
                ...
                ('rooms', models.JSONField(blank=True, default=dict, null=True, verbose_name='تفاصيل الغرف')),
                ...
                ('outdoor_spaces', models.JSONField(blank=True, default=dict, null=True, verbose_name='المساحات الخارجية')),
                ...
                ('rental_details', models.JSONField(blank=True, default=dict, null=True, verbose_name='تفاصيل الإيجار')),
                ('parking', models.JSONField(blank=True, default=dict, null=True, verbose_name='تفاصيل مواقف السيارات')),
                ('images', models.JSONField(blank=True, default=list, null=True, verbose_name='صور العقار')),
                ('videos', models.JSONField(blank=True, default=list, null=True, verbose_name='فيديوهات العقار')),
                ('virtual_tours', models.JSONField(blank=True, default=list, null=True, verbose_name='جولات افتراضية')),
                ('documents', models.JSONField(blank=True, default=list, null=True, verbose_name='مستندات العقار')),
                ('floor_plans', models.JSONField(blank=True, default=list, null=True, verbose_name='مخططات الطوابق')),
                ('features', models.JSONField(blank=True, default=list, null=True, verbose_name='المميزات')),
                ('amenities', models.JSONField(blank=True, default=list, null=True, verbose_name='المرافق')),
                ('building_services', models.JSONField(blank=True, default=dict, null=True, verbose_name='خدمات المبنى')),
                ('infrastructure', models.JSONField(blank=True, default=dict, null=True, verbose_name='البنية التحتية')),
                ...
                ('surroundings', models.JSONField(blank=True, default=dict, null=True, verbose_name='المحيط')),
                ('is_verified', models.BooleanField(default=False, verbose_name='تم التحقق')),
                ('verification_date', models.DateTimeField(blank=True, null=True, verbose_name='تاريخ التحقق')),
                ('verification_details', models.JSONField(blank=True, default=dict, null=True, verbose_name='تفاصيل التحقق')),
                ('is_featured', models.BooleanField(default=False, verbose_name='مميز')),
                ('is_published', models.BooleanField(default=False, verbose_name='منشور')),
                ('publish_date', models.DateTimeField(blank=True, null=True, verbose_name='تاريخ النشر')),
                ('views_count', models.PositiveIntegerField(default=0, verbose_name='عدد المشاهدات')),
                ('reference_ids', models.JSONField(blank=True, default=dict, null=True, verbose_name='أرقام مرجعية')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('files', models.JSONField(blank=True, default=list, null=True, verbose_name='ملفات المستند')),
                ...
                ('metadata', models.JSONField(blank=True, default=dict, null=True, verbose_name='بيانات وصفية')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='تاريخ الإنشاء')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='تاريخ التحديث')),
                ('role', models.CharField(choices=[('owner', 'مالك'), ('member', 'عضو'), ('observer', 'مراقب'), ('support', 'دعم'), ('admin', 'مدير')], default='member', max_length=20, verbose_name='الدور')),
        ...
        migrations.AddField(
            model_name='messagethread',
            name='participants',
            field=models.ManyToManyField(related_name='message_threads', through='base.ThreadParticipant', to=settings.AUTH_USER_MODEL, verbose_name='المشاركون'),
        ),
        migrations.CreateModel(
            name='Transaction',
            fields=[
        ...
        migrations.AddIndex(
            model_name='messagethread',
            index=models.Index(fields=['is_active', 'is_resolved'], name='message_thr_is_acti_8affc2_idx'),
        ),
        migrations.AddIndex(
