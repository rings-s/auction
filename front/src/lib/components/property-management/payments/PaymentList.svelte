	...
	{#if !compact}
		<div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4">
			<div class="grid grid-cols-1 gap-4 sm:grid-cols-4">
				...
				<!-- Type Filter -->
				<div>
					<label for="typeFilter" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
						{$t('payment.type')}
					</label>
					<select
						id="typeFilter"
				...
				<div class="flex items-end">
					<p class="text-sm text-gray-600 dark:text-gray-400">
						{$t('common.showing')} {displayedPayments.length} {$t('common.of')} {filteredPayments.length}
					</p>
				</div>
			</div>
		</div>
				...
				<table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
						...
						<tr>
							...
							<th class="px-6 py-3 text-left">
								...
								>
									...
									<svg class="h-4 w-4 {sortField === 'payment_id' ? 'text-gray-700 dark:text-gray-100' : 'text-gray-400'}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
							...
							<th class="px-6 py-3 text-left">
								...
								>
									...
									<svg class="h-4 w-4 {sortField === 'payment_type' ? 'text-gray-700 dark:text-gray-100' : 'text-gray-400'}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
										<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4" />
									</svg>
								</button>
							</th>
							...
							<th class="px-6 py-3 text-left">
								...
								>
									...
									<svg class="h-4 w-4 {sortField === 'amount' ? 'text-gray-700 dark:text-gray-100' : 'text-gray-400'}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
										<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4" />
									</svg>
								</button>
							</th>
							...
							<th class="px-6 py-3 text-left">
								...
								>
									...
									<svg class="h-4 w-4 {sortField === 'due_date' ? 'text-gray-700 dark:text-gray-100' : 'text-gray-400'}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
										<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4" />
									</svg>
								</button>
							</th>
							...
							<th class="px-6 py-3 text-left">
								...
								>
									...
									<svg class="h-4 w-4 {sortField === 'payment_date' ? 'text-gray-700 dark:text-gray-100' : 'text-gray-400'}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
										<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4" />
									</svg>
								</button>
							</th>
					...
					<tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
						{#each displayedPayments as payment (payment.id)}
							<tr class="hover:bg-gray-50 dark:hover:bg-gray-700 {isOverdue(payment) ? 'bg-red-50 dark:bg-red-900/20' : ''}">
								<!-- Payment ID -->
		...
		{#if selectedPayment}
			<div class="rounded-md bg-gray-50 p-4 dark:bg-gray-700">
				<div class="space-y-2">
					...
					<p class="text-sm text-gray-600 dark:text-gray-400">
						{paymentTypes.find(t => t.value === selectedPayment.payment_type)?.label} - {formatCurrency(selectedPayment.amount)}
					</p>
