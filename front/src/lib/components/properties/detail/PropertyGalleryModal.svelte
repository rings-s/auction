...
>
  ...
  <div class="w-full max-w-6xl flex items-center justify-between mb-4 text-white">
    ...
    <!-- Close Button -->
    <button 
      class="rounded-full bg-danger-600 hover:bg-danger-700 p-3 focus:outline-none transition-colors shadow-lg"
  ...
  {#if filteredMedia.length > 1}
    <div class="w-full max-w-6xl mt-2">
      <div 
        class="flex justify-center overflow-x-auto pb-2 px-2 scrollbar-thin scrollbar-thumb-neutral-600 scrollbar-track-transparent"
      ...
      >
        {#each filteredMedia as item, index}
          ...
          >
            <div class="h-full w-full bg-neutral-800 flex items-center justify-center overflow-hidden">
