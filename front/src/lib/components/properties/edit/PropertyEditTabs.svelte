          ...
          <div class="sm:col-span-3">
            ...
            <div class="mt-1">
              <input 
                ...
                readonly
                class="shadow-sm block w-full sm:text-sm border-gray-300 dark:border-gray-700 rounded-md dark:bg-gray-700 dark:text-gray-400 bg-gray-100 cursor-not-allowed"
              />
              <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                {$t('property.slugHelp')}
              </p>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                  {#each existingMedia as media}
                    <div class="relative group">
                      <div class="aspect-w-1 aspect-h-1 bg-gray-200 dark:bg-gray-600 rounded-lg overflow-hidden">
                      ...
                      <p class="mt-2 text-xs text-gray-600 dark:text-gray-400 truncate">{media.name}</p>
                    </div>
                  {/each}
                </div>
              </div>
