...
<form on:submit|preventDefault={handleSubmit} class="space-y-5">
	<!-- Email Display -->
	{#if emailReceived}
		<div class="mb-4 rounded-lg bg-gray-50 p-4 shadow-inner dark:bg-gray-700">
			<p class="text-sm font-medium text-gray-700 dark:text-gray-300">
				<span class="mb-1 block">{$t('auth.resetPasswordFor')}:</span>
	...
	{:else}
		...
		<div class="space-y-1">
            ...
            py-2.5 {errors.email && touched.email
	...
	<div class="space-y-1">
		...
		<input
			...
			class="
          block w-full appearance-none border px-3
          py-2.5 {errors.resetCode && touched.resetCode
				? 'border-red-300 dark:border-red-600'
				: 'border-gray-300 dark:border-gray-600'}
          focus:ring-primary-500 focus:border-primary-500 rounded-lg bg-white
          ...
          focus:outline-none dark:bg-gray-800 dark:text-white dark:placeholder-gray-500
        "
			placeholder="123456"
		/>
	...
	<div class="space-y-1">
		...
		<div class="relative">
            ...
            pr-10 {errors.newPassword && touched.newPassword
					? 'border-red-300 dark:border-red-600'
					: 'border-gray-300 dark:border-gray-600'}
            focus:ring-primary-500 focus:border-primary-500 rounded-lg bg-white
            text-gray-900 placeholder-gray-400 shadow-sm transition-all
	...
	<div class="space-y-1">
		...
		<div class="relative">
			<input
				...
				class="
            block w-full appearance-none border px-3 py-2.5
            pr-10 {errors.confirmPassword && touched.confirmPassword
					? 'border-red-300 dark:border-red-600'
					: 'border-gray-300 dark:border-gray-600'}
            focus:ring-primary-500 focus:border-primary-500 rounded-lg bg-white
            text-gray-900 placeholder-gray-400 shadow-sm transition-all
