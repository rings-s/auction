	...
	<div class="space-y-1">
		...
		<div class="relative">
			...
			<input
				...
				required
				class="
            block w-full appearance-none border py-3 pr-10
            pl-10 {passwordError && passwordTouched
					? 'border-red-300 dark:border-red-600'
					: 'border-gray-300 dark:border-gray-600'}
            focus:ring-primary-500 focus:border-primary-500 rounded-lg placeholder-gray-400
            shadow-sm focus:ring-2 focus:outline-none dark:placeholder-gray-500
	...
	<div class="flex items-center justify-between">
		<div class="flex items-center">
			<input
				...
				class="text-primary-600 focus:ring-primary-500 h-4 w-4 rounded border-gray-300 bg-white dark:border-gray-600 dark:bg-gray-800"
			/>
		...
		<a
			href="/reset-password"
			class="text-primary-600 hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300 text-sm font-medium transition-colors duration-200"
		>
