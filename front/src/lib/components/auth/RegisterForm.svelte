...
<form on:submit|preventDefault={handleSubmit} class="space-y-5">
	...
	<div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
		<div class="space-y-1">
			...
			<input
				...
				required
				class="
            block w-full appearance-none border px-3
            py-2.5 {errors.first_name && touched.first_name
					? 'border-red-300 dark:border-red-600'
					: 'border-gray-300 dark:border-gray-600'}
            focus:ring-primary-500 focus:border-primary-500 rounded-lg bg-white
            text-gray-900 placeholder-gray-400 shadow-sm transition-all
            duration-200 focus:ring-2 focus:outline-none dark:bg-gray-800
		...
		<div class="space-y-1">
			...
			<input
				...
				class="
            block w-full appearance-none border px-3
            py-2.5 {errors.last_name && touched.last_name
					? 'border-red-300 dark:border-red-600'
					: 'border-gray-300 dark:border-gray-600'}
            focus:ring-primary-500 focus:border-primary-500 rounded-lg bg-white
            text-gray-900 placeholder-gray-400 shadow-sm transition-all
	...
	<div class="space-y-1">
		...
		<div class="relative">
			...
			<input
				...
				required
				class="
            block w-full appearance-none border py-2.5 pr-3
            pl-10 {errors.email && touched.email
					? 'border-red-300 dark:border-red-600'
					: 'border-gray-300 dark:border-gray-600'}
            focus:ring-primary-500 focus:border-primary-500 rounded-lg bg-white
            text-gray-900 placeholder-gray-400 shadow-sm transition-all
	...
	<div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
		<div class="space-y-1">
			...
			<input
				...
				class="
            focus:ring-primary-500 focus:border-primary-500 block w-full appearance-none
            rounded-lg border border-gray-300
            bg-white px-3 py-2.5 text-gray-900
            placeholder-gray-400 shadow-sm transition-all duration-200
            focus:ring-2 focus:outline-none dark:border-gray-600 dark:bg-gray-800
            dark:text-white dark:placeholder-gray-500
          "
			/>
		</div>
	...
	<div class="space-y-1">
		...
		<select
          ...
          rounded-lg border border-gray-300
          bg-white px-3
          py-2.5 text-gray-900 shadow-sm transition-all
          duration-200 focus:ring-2 focus:outline-none dark:border-gray-600
	...
	<div class="space-y-1">
		...
		<div class="relative">
			<input
				...
				required
				class="
            block w-full appearance-none border px-3 py-2.5
            pr-10 {errors.password && touched.password
					? 'border-red-300 dark:border-red-600'
					: 'border-gray-300 dark:border-gray-600'}
            focus:ring-primary-500 focus:border-primary-500 rounded-lg bg-white
            text-gray-900 placeholder-gray-400 shadow-sm transition-all
		...
		{#if formData.password}
			<div class="mt-2">
				<div class="mb-1 flex items-center justify-between">
					...
					<span
						class="text-xs font-medium {passwordStrength < 30
							? 'text-red-600'
							: passwordStrength < 60
								? 'text-yellow-600'
								: passwordStrength < 80
	...
	<div class="space-y-1">
		...
		<div class="relative">
			<input
				...
				class="
            block w-full appearance-none border px-3 py-2.5
            pr-10 {errors.confirm_password && touched.confirm_password
					? 'border-red-300 dark:border-red-600'
					: 'border-gray-300 dark:border-gray-600'}
            focus:ring-primary-500 focus:border-primary-500 rounded-lg bg-white
            text-gray-900 placeholder-gray-400 shadow-sm transition-all
