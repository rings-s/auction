  ...
  <div class="space-y-6">
    ...
    <div class="space-y-1">
      ...
      <div class="relative">
        ...
        <input
          ...
          class="
            appearance-none block w-full pl-10 pr-3 py-3
            border {codeError && codeTouched ? 'border-red-300 dark:border-red-600' : 'border-gray-300 dark:border-gray-600'}
            rounded-lg shadow-sm placeholder-gray-400 dark:placeholder-gray-500
            focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500
            {codeError && codeTouched ? 'text-red-900 dark:text-red-300' : 'text-gray-900 dark:text-white'}
    ...
    <div class="text-center">
      <button
        ...
        disabled={loading}
        class="text-sm font-medium text-primary-600 hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300 transition-colors duration-200 disabled:opacity-50"
      >
        {$t('auth.resendCode')}
      </button>
    </div>
