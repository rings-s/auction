...
<div class="inline-flex items-center {sizeClasses} rounded-full {newBidAnimation ? 'bg-green-500 text-white animate-pulse' : 'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300'}">
