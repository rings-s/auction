...
{#if isLiveAuction}
  <!-- Live Auction Timer -->
  <div class="mb-4">
    <h3 class="text-base font-semibold text-neutral-900 dark:text-white mb-3 flex items-center">
...
{#if property}
  <div class="bg-white dark:bg-neutral-800 rounded-lg shadow-sm overflow-hidden">
    <div class="p-4">
      ...
      <!-- Property Image -->
      <div class="aspect-video bg-neutral-200 dark:bg-neutral-700 rounded-lg overflow-hidden mb-3">
      ...
      <h4 class="font-semibold text-neutral-900 dark:text-white mb-3 text-sm">
        {property.title}
      </h4>
      ...
      <dl class="space-y-2 text-sm">
        <div class="flex justify-between items-center">
          <dt class="font-medium text-neutral-500 dark:text-neutral-400">{$t('property.location')}</dt>
          <dd class="font-semibold text-neutral-900 dark:text-white text-right">{property.location?.city}, {property.location?.state}</dd>
        </div>
        <div class="flex justify-between items-center">
          <dt class="font-medium text-neutral-500 dark:text-neutral-400">{$t('property.propertyType')}</dt>
          <dd class="font-semibold text-neutral-900 dark:text-white">{property.property_type_display}</dd>
        </div>
        <div class="flex justify-between items-center">
          <dt class="font-medium text-neutral-500 dark:text-neutral-400">{$t('property.size')}</dt>
          <dd class="font-semibold text-neutral-900 dark:text-white">{property.size_sqm} {$t('property.sqm')}</dd>
        </div>
        <div class="flex justify-between items-center">
          <dt class="font-medium text-neutral-500 dark:text-neutral-400">{$t('property.marketValue')}</dt>
