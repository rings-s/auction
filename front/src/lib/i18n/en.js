...
export const enTranslations = {
	...
	property: {
		...
		messagePlaceholder:
			"Hi! I'm interested in this property. Could you please provide more details about...",
		...
		nearbyServicesInfo:
			'Information about schools, hospitals, shopping centers, and other amenities near this property will be displayed here.',
		...
		mediaUploadDesc:
			'Upload photos, floor plans, and documents for your property. Supported formats: JPEG, PNG, GIF, PDF.',
		...
		unauthorizedMessage:
			'You must be registered as a property owner or appraiser to add properties',
	...
	auction: {
		...
		requireBidVerificationHelp:
			'If enabled, bids will need manual verification before being accepted.',
		autoExtend: 'Auto-extend (minutes)',
		autoExtendHelp:
			'Automatically extend the auction if a bid is placed within this many minutes of the end time.',
		...
		largeBidWarning:
			'You are about to place a bid of {amount}. This is significantly higher than the current bid. Are you sure?',
		...
		term1:
			'All bids placed in the auction are final and cannot be withdrawn under any circumstances.',
		term2: 'The winning bidder must complete payment within 48 hours of the auction closing.',
		term3:
			'All properties are sold in their current condition ("as-is") without any express or implied warranties.',
		term4:
			'The buyer is responsible for completing the property title transfer in accordance with applicable laws and regulations.'
	},
	...
	messages: {
		...
		messageDelivered:
			'Your message has been delivered to the property owner. They will get back to you soon.',
	...
	dashboard: {
		...
		noProperties: 'No properties found',
		noPropertiesDesc:
			"You haven't added any properties yet. Create your first property listing to get started.",
		...
		noAuctionsDesc:
			"You haven't created any auctions yet. Start an auction for one of your properties.",
	...
	footer: {
		about: 'About Us',
		aboutText:
			'We are a leading real estate auction platform connecting buyers and sellers for residential, commercial, and land properties.',
	...
	hero: {
		...
		subtitle:
			'Join thousands of property investors in transparent, secure auctions for residential and commercial properties',
	...
	propertyManagement: {
		...
		subtitle: 'Manage your rental properties, tenants, and maintenance',
		...
		noTenantsYet: 'No tenants added yet',
		noPendingMaintenance: 'No pending maintenance requests'
	},

	rental: {
		title: 'Rental Properties',
		subtitle: 'Manage your rental property portfolio',
		description: 'View and manage all your rental properties in one place',
		create: 'Add Rental Property',
		createFirst: 'Add Your First Property',
		monthlyRent: 'Monthly Rent',
		annualIncome: 'Annual Income',
		occupancy: 'Occupancy',
		tenants: 'Tenants',
		noRentalInfo: 'No rental information available',
		searchPlaceholder: 'Search properties by title or address...',
	...
	maintenance: {
		title: 'Maintenance',
		subtitle: 'Track maintenance requests and repairs',
	...
	analytics: {
		title: 'Analytics',
		subtitle: 'Property performance insights and reports',
		propertyAnalytics: 'Property Analytics',
		portfolioAnalytics: 'Portfolio Analytics',
		exportData: 'Export Data',
		noData: 'No Analytics Data',
		noDataDescription: 'Add properties and tenants to see analytics',
		totalProperties: 'Total Properties',
		totalAnnualIncome: 'Total Annual Income',
		totalExpenses: 'Total Expenses',
		averageOccupancy: 'Average Occupancy',
		netIncome: 'Net Income',
		netIncomeDescription: 'Annual income minus expenses',
		averageROI: 'Average ROI',
		roiDescription: 'Return on investment percentage',
