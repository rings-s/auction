...
export const userPriority = derived(
  [user, dashboardStats],
  ([$user, $stats]) => {
...
export const canAccessAdvancedFeatures = derived(
  [user, userPriority],
  ([$user, $priority]) => {
...
export const canAccessSystemDashboard = derived(
  [user],
  ([$user]) => {
...
export const prioritizedActivity = derived(
  dashboardActivity,
  ($activity) => {
