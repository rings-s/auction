...
<!-- Main App Container -->
<div class="min-h-screen relative overflow-x-hidden bg-gradient-to-b from-white via-violet-50 to-violet-100 dark:from-slate-900 dark:via-slate-800 dark:to-violet-950 transition-all duration-700 ease-out">
	...
	{#if !loading && mounted}
		...
		<div class="navbar-glass relative z-50 border-b border-violet-200 dark:border-violet-700 transition-all duration-300">
			<Navbar />
		</div>
		
		<!-- Main Content Area -->
		<main 
			class="relative z-10 min-h-screen transition-all duration-500 ease-out"
		...
		<div class="footer-glass relative z-50 border-t border-violet-200 dark:border-violet-700 transition-all duration-300">
			<Footer />
		</div>
