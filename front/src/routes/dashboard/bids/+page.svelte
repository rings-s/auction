              ...
              <div class="flex items-start justify-between">
                ...
                <div class="flex-1">
                  <div class="flex items-center space-x-3 mb-2">
                    ...
                    <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium {getStatusColor(bid.status)}">
                      {bid.status_display}
                    </span>
                  ...
                  <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-xs">
                    ...
                    <div>
                      ...
                      <p class="font-medium {bid.is_verified ? 'text-green-600' : 'text-yellow-600'}">
